...
// san-serif fonts
user_pref("font.name.sans-serif.ja", "Inter Variable, IBM Plex Sans JP, Noto Emoji");
user_pref("font.name.sans-serif.x-unicode", "Inter Variable, IBM Plex Sans JP, Noto Emoji");
user_pref("font.name.sans-serif.x-western", "Inter Variable, IBM Plex Sans JP, Noto Emoji");
